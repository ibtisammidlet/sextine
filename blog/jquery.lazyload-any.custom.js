/*
THIS IS OFFICIAL jquery.lazyload-any.js FILE !!!
MY CODE IS BELOW...
 */
;
...
$(figure).hover(function () {
    $(cover).delay( 800 ).addClass("img-hide");
}, function () {
    $(cover).delay( 800 ).removeClass("img-hide");
});
$('.main').on('mouseover', '#myVideo', function(){
    $(this).delay( 800 ).get(0).play()
}).on('mouseout', '#myVideo', function(){
    $(this).delay( 800 ).get(0).pause();
});
